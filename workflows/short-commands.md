...
| 2 | Pokud není zrovna zobrazen číselný výběr: vylepši text podle KRITIK |
...
Všechny tyto varianty jsou akceptovány jako `ano`:
jo, jj, jasne, tak, ok, okay, dobra, sure, yes, dobrze, no dobra a podobné místní ekvivalenty.

Pokud kontext jasně neříká opak, všechny výše uvedené se vyhodnotí jako souhlas.
